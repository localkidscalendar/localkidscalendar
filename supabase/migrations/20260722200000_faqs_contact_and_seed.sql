...
select * from (values
  ...
  ('Can I save activities to view later?', 'Yes! Click the bookmark/save icon on any activity card to add it to your saved list. Access your saved activities anytime from My Account → Saved Activities. On the homepage, signed-in users can also use the Saved Activities filter button to show only bookmarked activities (combined with any other filters you already set).', 'Accounts', 4.0::numeric, 'active') ,
